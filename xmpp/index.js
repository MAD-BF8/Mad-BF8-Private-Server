...
wss.on("connection", ws => {
    ...
    var BotJid = `MAD-BOT@neonite.dev/V2:Fortnite:WIN::Neonite-Bot-By-BeatYT`
                            ...
                            if (body.length == 1) {
                                ...
                                profiledata.items[uuid.v4()] = {
                                    ...
                                    "attributes": {
                                        ...
                                        "giftedOn": new Date(),
                                        "params": {
                                            "userMessage": "Thanks for using MAD-BOT"
                                        },
                                        "favorite": false
                                    },
                                    "quantity": 1
            ...
            functions.SendMessage(JSON.stringify(
                {
                    ...
                    "connection": {
                        "id": `MAD-BOT${BotNumber != 0 ? BotNumber : ""}@neonite.dev/V2:Fortnite:WIN::Neonite-Bot-By-BeatYT${BotNumber != 0 ? BotNumber : ""}`,
                        "meta": {
                    ...
                    "account_id": `MAD-BOT${BotNumber != 0 ? BotNumber : ""}`,
                    "account_dn": "MAD-BOT",
                    "member_state_updated": {
                        "urn:epic:member:joinrequestusers_j": JSON.stringify({ "users": [{ "id": `MAD-BOT${BotNumber != 0 ? BotNumber : ""}`, "dn": "MAD-BOT", "plat": "WIN", "data": JSON.stringify({ "CrossplayPreference_i": "1", "SubGame_u": "1" }) }] }),
                        "urn:epic:member:dn_s": `MAD-BOT`,
                    },
                    "joined_at": new Date(),
                    "updated_at": new Date()
                }
