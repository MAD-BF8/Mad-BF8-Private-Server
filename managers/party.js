...
module.exports = (app) => {
                ...
                client.functions.SendMessage(JSON.stringify(
                    {
                        ...
                        "account_id": `MAD-BOT${counter != 0 ? counter : ''}`,
                        "account_dn": 'MAD-BOT',
    ...
    app.post('/party/api/v1/*/user/:accountId/pings/:pingerId', (req, res) => {
        ...
        if (req.params.accountId != "MAD-BOT") return;
    ...
    // /party/api/v1/Fortnite/parties/LobbyBotPartyLMFAO/members/MAD-BOT
    app.delete('/party/api/v1/*/parties/:PartyId/members/:accountId', (req, res) => {
        ...
        if (`${req.params.accountId}`.startsWith("MAD-BOT")) {
